...
public class DriverDO
{
    ...
    {
        return "DriverDO [id="
            + id + ", dateCreated=" + dateCreated + ", username=" + username + ", password=" + password + ", deleted=" + deleted + ", coordinate=" + coordinate
            + ", dateCoordinateUpdated=" + dateCoordinateUpdated + ", onlineStatus=" + onlineStatus + ", carDO=" + carDO + "]";
    }
