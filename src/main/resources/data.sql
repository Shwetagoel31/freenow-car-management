...
insert into car (id,license_plate,seat_count,convertible,rating,engine_type,car_size,manufacturer_name,date_created,deleted) 
values (1, 'CAR-001', 5, false, 3, 'PETROL', 'COMPACT', 'man1', now(), false);

insert into car (id,license_plate,seat_count,convertible,rating,engine_type,car_size,manufacturer_name,date_created,deleted) 
values (2, 'CAR-002', 8, true, 9, 'DIESEL', 'SEDAN', 'man1', now(), false);

insert into car (id,license_plate,seat_count,convertible,rating,engine_type,car_size,manufacturer_name,date_created,deleted) 
values (3, 'CAR-003', 5, false, 7, 'DIESEL', 'SEDAN', 'man2', now(), false);


-- Cars With Driver Associated
insert into car (id,license_plate,seat_count,convertible,rating,engine_type,car_size,manufacturer_name,date_created, deleted,driver_id) 
values (4, 'CAR-004', 5, false, 8, 'DIESEL', 'COMPACT', 'man2', now(), false, 4);

insert into car (id,license_plate,seat_count,convertible,rating,engine_type,car_size,manufacturer_name,date_created, deleted,driver_id)
values (5, 'CAR-005', 8, true, 9, 'DIESEL', 'HATCHBACK', 'man3', now(), false, 5);

insert into car (id,license_plate,seat_count,convertible,rating,engine_type,car_size,manufacturer_name,date_created, deleted,driver_id) 
values (6, 'CAR-006', 5, false, 3, 'PETROL', 'SEDAN', 'man3', now(), false, 6);